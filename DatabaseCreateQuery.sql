...
/****** Object:  Database [ITEMSDB]    Script Date: 7/23/2021 12:45:46 PM ******/
CREATE DATABASE [ITEMSDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ITEMSDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\ITEMSDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ITEMSDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\ITEMSDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [ITEMSDB] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [ITEMSDB] SET RECOVERY FULL 
GO
...
ALTER DATABASE [ITEMSDB] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
